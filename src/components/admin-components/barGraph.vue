<template>
    <div class="max-h-min w-full bg-white rounded-lg drop-shadow-lg dark:bg-gray-800 p-4 outline outline-main outline-2">
      ...
      <!-- Graph Container -->
      <div id="column-chart" style="height: 320px; width: 100%;"></div>
